...
SpecialSampleAsErrorBand ${originalCrossSectionBaseName}_afterMoNARemoved_with_${neutronBandName}.root ../me6A/multiNeutronMC.root ${crossTalkBandName} ../crossTalkUpME6A/multiNeutron_noSystsMC.root
