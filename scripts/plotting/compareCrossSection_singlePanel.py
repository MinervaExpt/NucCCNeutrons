...
ROOT.gStyle.SetTitleOffset(1.35, "xyz")
...
dataRatio.GetYaxis().SetTitleSize(0.12)
...
dataRatio.GetXaxis().SetTitleSize(0.12)
dataRatio.GetXaxis().SetTitleOffset(1.1)
dataRatio.GetXaxis().SetLabelSize(labelSize)
